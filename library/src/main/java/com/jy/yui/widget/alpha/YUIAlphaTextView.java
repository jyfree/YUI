 ...
 * @author: jy
 */
public class YUIAlphaTextView extends AppCompatTextView {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaTextView(Context context) {
        super(context);
    }

    public YUIAlphaTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaTextView(Context context, AttributeSet attrs, int defStyleAttr) {
