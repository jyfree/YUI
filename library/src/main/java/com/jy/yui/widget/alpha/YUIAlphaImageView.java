 ...
 * @author: jy
 */
public class YUIAlphaImageView extends AppCompatImageView {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaImageView(Context context) {
        super(context);
    }

    public YUIAlphaImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaImageView(Context context, AttributeSet attrs, int defStyleAttr) {
