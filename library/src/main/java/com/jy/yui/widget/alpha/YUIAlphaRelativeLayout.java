 ...
 * @author: jy
 */
public class YUIAlphaRelativeLayout extends RelativeLayout {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaRelativeLayout(Context context) {
        super(context);
    }

    public YUIAlphaRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
