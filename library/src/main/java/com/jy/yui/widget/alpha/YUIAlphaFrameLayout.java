 ...
 * @author: jy
 */
public class YUIAlphaFrameLayout extends FrameLayout {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaFrameLayout(Context context) {
        super(context);
    }

    public YUIAlphaFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
