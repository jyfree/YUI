 ...
 * @author: jy
 */
public class YUIAlphaButton extends AppCompatButton {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaButton(Context context) {
        super(context);
    }

    public YUIAlphaButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaButton(Context context, AttributeSet attrs, int defStyleAttr) {
