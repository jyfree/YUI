package com.jy.yui.widget.alpha;

import android.content.Context;
import android.util.AttributeSet;

import com.jy.yui.widget.textview.ShapeTextView;
 ...
 * @author: jy
 */
public class YUIAlphaShapeTextView extends ShapeTextView {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaShapeTextView(Context context) {
        super(context);
    }

    public YUIAlphaShapeTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaShapeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
