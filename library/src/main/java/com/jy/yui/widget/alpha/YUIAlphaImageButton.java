 ...
 * @author: jy
 */
public class YUIAlphaImageButton extends AppCompatImageButton {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaImageButton(Context context) {
        super(context);
    }

    public YUIAlphaImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
