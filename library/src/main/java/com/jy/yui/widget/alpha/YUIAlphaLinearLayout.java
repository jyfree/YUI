 ...
 * @author: jy
 */
public class YUIAlphaLinearLayout extends LinearLayout {

    private IAlphaViewHelper mAlphaViewHelper;

    public YUIAlphaLinearLayout(Context context) {
        super(context);
    }

    public YUIAlphaLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YUIAlphaLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
