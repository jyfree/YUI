package com.jy.yui.widget.shadow;
...
public class ShadowDrawable extends Drawable {
    ...
    public static ShadowDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int shadowRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shadowRadius, 8);
        ...
        int shapeRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shapeRadius, 5);
